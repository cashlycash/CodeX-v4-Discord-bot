...
module.exports = {
  ...
  options: [
	...
	run: async (client, interaction) => {
        ...
        .addField("JoinedAt", `<t:${member.joinedTimestamp.toString().splice(0, -3)}:R>`, true)
        .addField("Account Created At", `<t:${member.user.createdTimestamp.toString().splice(0, -3)}:R>`, true)
